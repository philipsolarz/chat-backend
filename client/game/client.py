...
def create_world(name: str, description: str = None, genre: str = None, get_user_by_email: bool = False) -> Optional[Dict[str, Any]]:
    """Create a new world"""
    if not state.access_token:
        console.print("[yellow]Not logged in[/yellow]")
        return None
...
def show_world_details(world_id: str):
    ...
    details = [
        ...
        f"[bold cyan]Public:[/bold cyan] {'Yes' if world.get('get_user_by_email', False) else 'No'}",
...
def interactive_create_world():
    ...
    get_user_by_email = Confirm.ask("Make public?", default=False)
    
    world = create_world(name, description, genre, get_user_by_email)
    if world:
...
def create_character(name: str, description: str = None) -> Optional[Dict[str, Any]]:
...
def interactive_create_character():
    ...
    character = create_character(name, description, get_user_by_email)
    if character:
...
def show_characters():
    ...
    for char in characters:
        table.add_row(
            ...
            "✓" if char.get("get_user_by_email", False) else "✗"
        )
